...
// over the loop counter in simulation/nbio. The code between never knows which one it holds.
// Nothing here advance time; that is the loop's job, and the loop live in simulation/nbio.
package time
