...
func (builder Assertion_Builder) Range_Int(
	...
	return production_range(builder, value, minimum, maximum)
}
...
func (builder Assertion_Builder) Enum_Int(
	...
	return production_enum_2(builder, value, first, second)
}
...
func (builder Assertion_Builder) Enum_3_Int(
	...
	return production_enum_3(builder, value, first, second, third)
}
...
func (builder Assertion_Builder) Enum_4_Int(
	...
	return production_enum_4(builder, value, first, second, third, fourth)
}
