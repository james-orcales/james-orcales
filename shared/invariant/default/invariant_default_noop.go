...
func Range[Value invariant.Integer](value Value, minimum Value, maximum Value, message string) {
	return
}

// Enum states nothing in this build.
func Enum[Value invariant.Integer](value Value, first Value, second Value, message string) {
	return
}
